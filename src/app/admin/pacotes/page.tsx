          ...
          <section key={cat.key} className="mb-12">
            ...
            <details className="mb-3 rounded-mi bg-mi-branco p-4 shadow-suave">
              ...
              <form action={adminCreatePacote} className="mt-3 space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <input name="nome" placeholder="Nome" required className="input-mi !py-2 text-sm" />
                  <input name="preco" placeholder="R$ 0.000" required className="input-mi !py-2 text-sm" />
                  <input name="parcela" placeholder="parcelamento (opcional)" className="input-mi !py-2 text-sm" />
                  <input name="sort" type="number" placeholder="ordem" defaultValue={0} className="input-mi w-20 !py-2 text-sm" />
                  <label className="flex items-center gap-1 text-xs">
                    <input type="checkbox" name="destaque" /> destaque
                  </label>
                </div>
                <textarea name="itens" rows={4} placeholder="Um item por linha" className="input-mi w-full text-sm" />
                <input name="rodape" placeholder="rodapé / cortesia (opcional)" className="input-mi w-full !py-2 text-sm" />
            ...
            {meusPacotes.map((p) => (
              <div key={p.id} className="mb-2 rounded-mi bg-mi-branco p-3 shadow-suave">
                <form action={adminUpdatePacote} className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <input name="nome" defaultValue={p.nome} required className="input-mi !py-2 text-sm" />
                    <input name="preco" defaultValue={p.preco} required className="input-mi !py-2 text-sm" />
                    <input name="parcela" defaultValue={p.parcela ?? ""} placeholder="parcelamento" className="input-mi !py-2 text-sm" />
                    <input name="sort" type="number" defaultValue={p.sort} className="input-mi w-20 !py-2 text-sm" />
                    <label className="flex items-center gap-1 text-xs">
                  ...
                  <input name="rodape" defaultValue={p.rodape ?? ""} placeholder="rodapé / cortesia" className="input-mi w-full !py-2 text-sm" />
            ...
            <details className="mb-3 rounded-mi bg-mi-branco p-4 shadow-suave">
              ...
              <form action={adminCreateFaq} className="mt-3 space-y-2">
                <input type="hidden" name="categoria" value={cat.key} />
                <input name="pergunta" placeholder="Pergunta" required className="input-mi w-full !py-2 text-sm" />
                <textarea name="resposta" rows={2} placeholder="Resposta" required className="input-mi w-full text-sm" />
                <input name="sort" type="number" defaultValue={0} className="input-mi w-20 !py-2 text-sm" />
            ...
            {minhasFaqs.map((f) => (
              <div key={f.id} className="mb-2 rounded-mi bg-mi-branco p-3 shadow-suave">
                <form action={adminUpdateFaq} className="space-y-2">
                  ...
                  <input name="pergunta" defaultValue={f.pergunta} required className="input-mi w-full !py-2 text-sm" />
                  <textarea name="resposta" rows={2} defaultValue={f.resposta} required className="input-mi w-full text-sm" />
                  <div className="flex items-center gap-2">
                    <input name="sort" type="number" defaultValue={f.sort} className="input-mi w-20 !py-2 text-sm" />
                    <label className="flex items-center gap-1 text-xs">
