  ...
  return (
    <>
      ...
      <details className="mb-6 rounded-mi bg-mi-superficie-elevada p-4 shadow-suave">
        <summary className="cursor-pointer font-corpo text-sm text-mi-marrom">＋ Lançar custo</summary>
        <form action={adminCreateExpense} className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <label className="block sm:col-span-2">
            <span className="mb-1 block text-xs text-mi-texto/60">Descrição</span>
          ...
          <label className="block">
            <span className="mb-1 block text-xs text-mi-texto/60">Competência</span>
            <input type="date" name="competenceDate" required className="input-mi" />
          </label>
          <label className="block">
            <span className="mb-1 block text-xs text-mi-texto/60">Pagamento (caixa, opcional)</span>
          ...
          <label className="block">
            <span className="mb-1 block text-xs text-mi-texto/60">Fornecedor (opcional)</span>
          ...
          <label className="block sm:col-span-2">
            <span className="mb-1 block text-xs text-mi-texto/60">Observação (opcional)</span>
      ...
      <form className="mb-4 flex flex-wrap items-end gap-3" action="/admin/financeiro/custos">
        ...
        <span className="ml-auto self-center text-sm text-mi-texto/70">
      ...
      <div className="overflow-x-auto rounded-mi bg-mi-superficie-elevada shadow-suave">
        <table className="w-full text-sm">
          ...
          <tbody>
            {despesas.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center text-mi-texto/55">
