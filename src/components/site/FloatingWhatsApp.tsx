...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 inline-flex h-14 w-14 items-center justify-center rounded-full bg-mi-marrom-escuro text-mi-branco shadow-suave transition-colors hover:bg-mi-marrom"
    >
