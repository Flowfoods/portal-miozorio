    ...
    <header className="sticky top-0 z-40 border-b border-mi-cinza/60 bg-mi-bege/80 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-3">
        ...
        <div className="flex items-center gap-1.5">
          <Link
            href="/agendar"
            className="inline-flex min-h-[44px] items-center rounded-mi bg-mi-marrom-escuro px-4 font-corpo text-sm text-mi-branco transition-colors hover:bg-mi-marrom"
          >
            Agendar
          </Link>
          <MobileNav />
