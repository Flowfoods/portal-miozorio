  ...
  return (
    <div>
      <button
        ...
        onClick={entrar}
        disabled={busy}
        className="flex w-full items-center justify-center gap-2 rounded-mi border border-mi-marrom px-4 py-3 font-corpo text-mi-marrom transition-colors hover:bg-mi-marrom hover:text-white disabled:opacity-60"
      >
