...
export default function NovoAgendamento({
  ...
  return (
    <div className="rounded-mi border border-mi-cinza bg-mi-branco p-4 shadow-suave">
      ...
      <div className="space-y-4">
        ...
        <div className="inline-flex rounded-mi bg-mi-cinza p-1">
          {(["studio", "home"] as const).map((loc) => (
            <button
              ...
              className={`min-h-[38px] rounded-[10px] px-4 text-sm transition-colors ${
                location === loc
        ...
        <div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-mi-texto">Horário</span>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              {!slotsLoading && slots && slots.length === 0 && (
                <span className="text-sm text-mi-texto/60">
                  Sem horário no padrão neste dia — use “horário livre”.
                </span>
              )}
              {slots?.map((hhmm) => (
                <button
                  ...
                  className={`min-h-[40px] rounded-mi border px-3 text-sm transition-colors ${
                    time === hhmm
        ...
        <p className="-mt-2 text-xs text-mi-texto/50">
          O aviso automático no WhatsApp entra junto com as automações (em breve).
        </p>
        ...
        <button
          ...
          onClick={submit}
          className="min-h-[48px] w-full rounded-mi bg-mi-marrom text-sm text-white shadow-suave hover:bg-mi-marrom-escuro disabled:opacity-50"
        >
